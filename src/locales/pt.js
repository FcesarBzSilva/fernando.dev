export const pt = {
  ...
  hero: {
    ...
    description: "Especialista em construir soluções escaláveis utilizando SOLID e Clean Architecture com Node.js, React e AWS. Transformando problemas complexos de negócios em arquiteturas resilientes, com forte foco em boas práticas de código e manutenção de longo prazo.",
    buttonProjects: "Ver Projetos",
    buttonResume: "Baixar Currículo"
  },
  about: {
    title: "Sobre Mim",
    ...
    p3End: "para garantir estabilidade e fácil manutenção a longo prazo. Além do código, sou membro ativo e staff organizador na comunidade GDG (Google Developer Group) Natal/RN (Edições 2025 e 2026).",
    ...
    seDesc: "Clean Architecture, Arquitetura MVC, Microserviços, CI/CD, Testes e SOLID.",
  ...
  skills: {
    ...
    subtitle: "Especializações focadas no design de softwares confiáveis, escaláveis e na construção de infraestruturas cloud robustas.",
    catBackend: "Back-End & APIs",
    catFrontend: "Front-End",
    catCloud: "Cloud & DevOps",
    catDb: "Banco de Dados & ORM",
    catEngineering: "Engenharia & Segurança"
  },
  projects: {
  ...
  contact: {
    ...
    subtitle: "Estou sempre aberto a novos desafios de desenvolvimento back-end, arquiteturas complexas na AWS ou sistemas full-stack modernos. Entre em contato para construirmos produtos de sucesso!",
    location: "Localização",
    locationValue: "Parnamirim, RN - Brasil",
    whatsappSubtitle: "Preferência de contato rápida para alinhamento profissional, dúvidas e oportunidades de projetos.",
    whatsappBtn: "Chamar no WhatsApp"
  },
  footer: {
    rights: "Todos os direitos reservados.",
    developed: "Desenvolvido com visão focada em resultados e escalabilidade"
  }
};
